...
**Command group:** `identity`  
**Owning agent:** `identity-access-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit account lifecycle** using the owning agent and required core skills.
...
- confirm the task falls within `identity-access-engineer` ownership;
