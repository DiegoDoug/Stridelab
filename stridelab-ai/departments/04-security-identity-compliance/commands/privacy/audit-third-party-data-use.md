# /audit-third-party-data-use

**Department:** Security, Identity & Compliance  
**Command group:** `privacy`  
**Owning agent:** `privacy-data-governance-specialist`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit third party data use** using the owning agent and required core skills.
...
- confirm the task falls within `privacy-data-governance-specialist` ownership;
