...
**Command group:** `security`  
**Owning agent:** `application-security-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit api security** using the owning agent and required core skills.
...
- confirm the task falls within `application-security-engineer` ownership;
