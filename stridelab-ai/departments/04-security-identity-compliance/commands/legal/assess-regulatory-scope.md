...
**Command class:** `analysis`

## Intent

Execute the approved StrideLab workflow for **assess regulatory scope** using the owning agent and required core skills.
...
1. Define the question, decision, or operational concern this analysis informs.
2. Gather the most authoritative current evidence/data available.
3. Separate facts, assumptions, calculations, and recommendations.
4. Identify limitations, uncertainty, and downstream implications.
...
An evidence-backed analysis with sources/data, assumptions, findings, implications, and unresolved questions.
