# /audit-consent-requirements

**Department:** Security, Identity & Compliance  
**Command group:** `legal`  
**Owning agent:** `legal-compliance-researcher`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit consent requirements** using the owning agent and required core skills.
...
- confirm the task falls within `legal-compliance-researcher` ownership;
