# /audit-ugc-compliance

**Department:** Security, Identity & Compliance  
**Command group:** `apple-compliance`  
**Owning agent:** `apple-platform-compliance-specialist`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit ugc compliance** using the owning agent and required core skills.
...
- confirm the task falls within `apple-platform-compliance-specialist` ownership;
