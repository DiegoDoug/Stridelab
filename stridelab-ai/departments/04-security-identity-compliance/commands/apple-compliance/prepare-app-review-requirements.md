# /prepare-app-review-requirements
...
Execute the approved StrideLab workflow for **prepare app review requirements** using the owning agent and required core skills.
