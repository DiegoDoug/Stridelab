...
**Owning agent:** `security-compliance-reviewer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **verify security boundary** using the owning agent and required core skills.
...
- confirm the task falls within `security-compliance-reviewer` ownership;
