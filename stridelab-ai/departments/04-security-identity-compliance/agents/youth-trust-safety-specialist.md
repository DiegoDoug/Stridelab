...
Designs and audits safety controls for StrideLab's 13+ user base, UGC, and coach-athlete communication.
...
### Owns
- age safeguards
- reporting/blocking/moderation workflows
- safety escalation
- coach-athlete communication review

### Does not own
- criminal/legal adjudication
- chat implementation
