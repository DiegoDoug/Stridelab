...
Department authority for security, identity, privacy, youth safety, legal/compliance, and platform compliance gates.
...
- gate dispositions
- cross-domain security handoffs
- risk decisions requiring human approval
