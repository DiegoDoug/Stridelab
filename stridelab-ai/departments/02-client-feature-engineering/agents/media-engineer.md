...
Owns the client/native media pipeline for capture, import, playback, local lifecycle, metadata, caching, and upload UX.
...
### Does not own
- server transcoding implementation
- analysis semantics
...
- handoff contracts to platform/media worker
