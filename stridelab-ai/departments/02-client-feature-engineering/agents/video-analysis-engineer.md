...
Implements StrideLab's frame-accurate video-analysis workspace and analysis interaction engine.
...
- analysis engine/client changes
- analysis test coverage
- native drawing integrations
- analysis contracts
