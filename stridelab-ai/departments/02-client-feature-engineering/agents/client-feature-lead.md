...
Coordinates client-side implementation across mobile, web, media, analysis, planning, and workout execution.
...
### Owns
- client implementation decomposition
- cross-feature consistency
- client integration sequencing
