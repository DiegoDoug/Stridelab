...
Implements athlete workout execution, logging, personal workouts, history, and performance-oriented client views.
...
- session execution
- personal workout UI
- history/performance views

### Does not own
- coach training-cycle planning
- commercial entitlement rules
- server policy
