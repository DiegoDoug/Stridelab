# /audit-client-feature

**Department:** Client & Feature Engineering  
**Command group:** `general`  
**Owning agent:** `client-feature-lead`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit client feature** using the owning agent and required core skills.
...
- confirm the task falls within `client-feature-lead` ownership;
