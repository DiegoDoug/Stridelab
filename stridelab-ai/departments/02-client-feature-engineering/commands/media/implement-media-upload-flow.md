...
**Command group:** `media`  
**Owning agent:** `media-engineer`  
**Command class:** `implementation`

## Intent

Execute the approved StrideLab workflow for **implement media upload flow** using the owning agent and required core skills.
...
- confirm the task falls within `media-engineer` ownership;
