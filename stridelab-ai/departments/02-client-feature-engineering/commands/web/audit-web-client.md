...
**Command group:** `web`  
**Owning agent:** `web-client-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit web client** using the owning agent and required core skills.
...
- confirm the task falls within `web-client-engineer` ownership;
