# /implement-personal-workouts

**Department:** Client & Feature Engineering  
**Command group:** `workout-performance`  
**Owning agent:** `workout-performance-engineer`  
**Command class:** `implementation`

## Intent

Execute the approved StrideLab workflow for **implement personal workouts** using the owning agent and required core skills.
...
- confirm the task falls within `workout-performance-engineer` ownership;
