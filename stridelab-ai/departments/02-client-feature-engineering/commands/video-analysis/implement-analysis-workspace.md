# /implement-analysis-workspace

**Department:** Client & Feature Engineering  
**Command group:** `video-analysis`  
**Owning agent:** `video-analysis-engineer`  
**Command class:** `implementation`

## Intent

Execute the approved StrideLab workflow for **implement analysis workspace** using the owning agent and required core skills.
...
- confirm the task falls within `video-analysis-engineer` ownership;
