...
**Command group:** `ios-ipados`  
**Owning agent:** `ios-ipados-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit ios client** using the owning agent and required core skills.
...
- confirm the task falls within `ios-ipados-engineer` ownership;
