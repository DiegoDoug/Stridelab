# /implement-training-cycle-editor

**Department:** Client & Feature Engineering  
**Command group:** `training`  
**Owning agent:** `training-planning-engineer`  
**Command class:** `implementation`

## Intent

Execute the approved StrideLab workflow for **implement training cycle editor** using the owning agent and required core skills.
...
- confirm the task falls within `training-planning-engineer` ownership;
