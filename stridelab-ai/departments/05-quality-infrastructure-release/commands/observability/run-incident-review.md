...
**Command group:** `observability`  
**Owning agent:** `observability-incident-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **run incident review** using the owning agent and required core skills.
...
- confirm the task falls within `observability-incident-engineer` ownership;
