...
Execute the approved StrideLab workflow for **audit battery impact** using the owning agent and required core skills.
...
- confirm the task falls within `performance-engineer` ownership;
