...
**Command group:** `reliability`  
**Owning agent:** `site-reliability-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **run resilience test** using the owning agent and required core skills.
...
- confirm the task falls within `site-reliability-engineer` ownership;
