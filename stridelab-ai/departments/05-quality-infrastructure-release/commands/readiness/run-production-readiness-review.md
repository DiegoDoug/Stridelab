...
**Department:** Quality, Infrastructure & Release  
**Command group:** `readiness`  
**Owning agent:** `production-readiness-reviewer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **run production readiness review** using the owning agent and required core skills.
...
`stridelab-ai/departments/05-quality-infrastructure-release/skills/core/<skill-name>/`
...
- confirm the task falls within `production-readiness-reviewer` ownership;
...
- A technical PASS must cite observed evidence.
- Release commands cannot override security/compliance blockers or required human approval.
