...
Execute the approved StrideLab workflow for **record release** using the owning agent and required core skills.
...
A canonical project-memory/knowledge artifact written to the approved source-of-truth location.
