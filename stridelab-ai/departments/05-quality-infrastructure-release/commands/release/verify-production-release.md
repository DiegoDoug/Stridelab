...
**Command group:** `release`  
**Owning agent:** `release-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **verify production release** using the owning agent and required core skills.
...
- confirm the task falls within `release-engineer` ownership;
