...
**Command group:** `quality`  
**Owning agent:** `quality-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit test coverage** using the owning agent and required core skills.
...
- confirm the task falls within `quality-engineer` ownership;
