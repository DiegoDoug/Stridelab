...
**Owning agent:** `devops-infrastructure-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **verify environment parity** using the owning agent and required core skills.
...
- confirm the task falls within `devops-infrastructure-engineer` ownership;
