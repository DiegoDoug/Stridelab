...
**Owning agent:** `support-operations-specialist`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit support readiness** using the owning agent and required core skills.
...
- confirm the task falls within `support-operations-specialist` ownership;
