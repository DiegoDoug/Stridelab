...
**Command group:** `knowledge`  
**Owning agent:** `documentation-knowledge-manager`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit documentation** using the owning agent and required core skills.
...
- confirm the task falls within `documentation-knowledge-manager` ownership;
