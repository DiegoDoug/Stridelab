# /define-agent-artifact-contract
...
Execute the approved StrideLab workflow for **define agent artifact contract** using the owning agent and required core skills.
