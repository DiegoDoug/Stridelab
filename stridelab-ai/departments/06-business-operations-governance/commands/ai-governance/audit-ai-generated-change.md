# /audit-ai-generated-change

**Department:** Business Operations & Governance  
**Command group:** `ai-governance`  
**Owning agent:** `ai-governance-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit ai generated change** using the owning agent and required core skills.
...
- confirm the task falls within `ai-governance-engineer` ownership;
