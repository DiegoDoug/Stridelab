# /audit-plan-economics

**Department:** Business Operations & Governance  
**Command group:** `cost`  
**Owning agent:** `finops-cost-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit plan economics** using the owning agent and required core skills.
...
- confirm the task falls within `finops-cost-engineer` ownership;
