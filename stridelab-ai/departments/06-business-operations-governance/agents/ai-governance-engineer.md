...
Defines and enforces how AI agents, skills, commands, evidence, approvals, and verification operate in StrideLab development.
...
### Does not own
- specialist domain implementation
