...
Coordinates StrideLab platform/data implementation and preserves backend, data, sync, realtime, search, and reporting boundaries.
...
- data-contract coherence
- backend integration sequencing
- department implementation review

### Does not own
- security policy semantics
- product workflow approval
- release approval
