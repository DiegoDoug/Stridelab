...
**Owning agent:** `platform-data-lead`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit platform capability** using the owning agent and required core skills.
...
- confirm the task falls within `platform-data-lead` ownership;
