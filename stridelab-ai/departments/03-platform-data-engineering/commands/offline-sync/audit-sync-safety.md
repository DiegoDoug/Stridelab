...
**Command group:** `offline-sync`  
**Owning agent:** `sync-offline-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit sync safety** using the owning agent and required core skills.
...
- confirm the task falls within `sync-offline-engineer` ownership;
