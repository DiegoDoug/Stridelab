# /verify-offline-online-equivalence

**Department:** Platform & Data Engineering  
**Command group:** `verification`  
**Owning agent:** `platform-data-reviewer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **verify offline online equivalence** using the owning agent and required core skills.
...
- confirm the task falls within `platform-data-reviewer` ownership;
