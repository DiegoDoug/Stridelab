...
**Command group:** `reporting-analytics`  
**Owning agent:** `reporting-analytics-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit report correctness** using the owning agent and required core skills.
...
- confirm the task falls within `reporting-analytics-engineer` ownership;
