...
**Owning agent:** `search-retrieval-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit search relevance** using the owning agent and required core skills.
...
- confirm the task falls within `search-retrieval-engineer` ownership;
