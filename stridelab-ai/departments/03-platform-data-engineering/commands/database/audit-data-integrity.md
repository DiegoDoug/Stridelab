...
**Owning agent:** `database-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit data integrity** using the owning agent and required core skills.
...
- confirm the task falls within `database-engineer` ownership;
