# /audit-realtime-delivery

**Department:** Platform & Data Engineering  
**Command group:** `realtime`  
**Owning agent:** `realtime-messaging-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit realtime delivery** using the owning agent and required core skills.
...
`stridelab-ai/departments/03-platform-data-engineering/skills/core/<skill-name>/`
...
- confirm the task falls within `realtime-messaging-engineer` ownership;
...
- Authorization/RLS semantics come from Department 04; do not invent or weaken them.
- Account for offline/retry/idempotency behavior where the workflow can occur trackside.
