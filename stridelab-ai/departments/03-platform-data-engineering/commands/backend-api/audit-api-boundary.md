...
**Command group:** `backend-api`  
**Owning agent:** `backend-api-engineer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit api boundary** using the owning agent and required core skills.
...
- confirm the task falls within `backend-api-engineer` ownership;
