...
**Command group:** `ux`  
**Owning agent:** `ux-architect`  
**Command class:** `design`

## Intent

Execute the approved StrideLab workflow for **design information architecture** using the owning agent and required core skills.
...
- confirm the task falls within `ux-architect` ownership;
