...
**Owning agent:** `ux-research-accessibility-reviewer`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **run usability review** using the owning agent and required core skills.
...
- confirm the task falls within `ux-research-accessibility-reviewer` ownership;
