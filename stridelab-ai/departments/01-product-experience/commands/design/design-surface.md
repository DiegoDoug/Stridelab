...
**Owning agent:** `product-designer`  
**Command class:** `design`

## Intent

Execute the approved StrideLab workflow for **design surface** using the owning agent and required core skills.
...
- confirm the task falls within `product-designer` ownership;
