...
**Owning agent:** `domain-workflow-architect`  
**Command class:** `review`

## Intent

Execute the approved StrideLab workflow for **audit workflow** using the owning agent and required core skills.
...
- confirm the task falls within `domain-workflow-architect` ownership;
