...
Per the review mandate ("do not rubber-stamp 'smallest coherent MVP'; a capability required only because another *optional* capability was included must not become 'required' through circular reasoning"), the seven capabilities named for challenge — F-10, F-26/F-27, F-30, F-31/F-32, F-34, F-39, F-42 — were re-examined by the independent D01 lens (`stridelab-ai/orchestration/reviews/step2-dept01/01-d01-product.md`).
